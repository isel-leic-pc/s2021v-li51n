...
namespace Examples.Async
{
    ...
    public class AsyncSemaphore
    {
        ...
        public AsyncSemaphore(int initialUnits)
        {
            ...
            _cancellationCallback = node => { TryCancel((LinkedListNode<Request>) node!, true); };
            _timeoutCallback = node => { TryCancel((LinkedListNode<Request>) node!, false); };
        }
