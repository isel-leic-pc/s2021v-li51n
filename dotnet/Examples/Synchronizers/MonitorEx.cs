    ...
    public class MonitorEx
    {
        public static void Wait(object mlock, object condition, TimeSpan timeout)
        {
            ...
            finally
            {
                ...
                EnterNonInterruptibly(mlock, out var wasInterrupted ); // can throw ThreadInterruptedException
                if (wasInterrupted)
                {
        ...
        private static void EnterNonInterruptibly(object mlock, out bool wasInterrupted)
        {
